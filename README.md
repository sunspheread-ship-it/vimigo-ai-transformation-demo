...
4. In Apps Script Project Settings, add the Script Property `OPENAI_API_KEY`. Optionally set `OPENAI_MODEL`; the default is `gpt-5.6-luna` for cost-sensitive drafting.
...
7. After submission, generate drafts, review/edit every report, approve all six, then export the six PDFs.
